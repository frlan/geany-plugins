...
\texttt{\{OPENING\}} & Will be replaced by »Dear Sir or Madame« in local
	\textit{LaTeX} is running with. If you like to overwrite it, please
...
\begin{figure}[h!]
	...
	\caption{Insert label dialog on \textit{LaTeX} 0.5}
\end{figure}

After an label was added \textit{LaTeX} is offering a dialog for
...
\begin{figure}[h!]
	...
	\caption{Insert reference dialog on \textit{LaTeX} 0.5}
\end{figure}
