...
\section{Usage}
\begin{figure}[h!]
    \centering{\includegraphics[height=5cm]{img/plugin_manager.png}}
...
BibTeX-menu includes a basic set of functions connected with \hologo{BibTeX}.
...
\subsection{Inserting cite-reference}
...
\section{The \hologo{BibTeX}-menu}
...
\subsection{Document backward search}
...
\section{Geany's template system}
...
\section{Geany's code snippet function}
